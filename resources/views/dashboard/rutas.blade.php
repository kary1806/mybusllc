           ...
           <nav class="navbar back" style="background: #a1d038 ">
            ...
            <div class="row mt-4">
                  ...
                  <div class="card">
                     <form class="card-body">
                        ...
                        <div class="form-group">
                            <input type="text" data-bind="value:nombre_ruta"
                            name="ruta" class="form-control" placeholder="Nombre de la ruta">
                            </input>
                        </div>
                         ...
                         <div class="form-group">
                            <input type="text" data-bind="value:valor,onlyNumber:valor"
                            name="destino" class="form-control" placeholder="Valor de Peaje">
                            </input>
                        </div>


                       <div class="form-group">
                         <select class="form-control" data-bind="value:bus_id">
                            <option value=0>[Seleccione un bus]</option>
                            <!--ko foreach:{ data:listado_buses, as:'item'} -->
                              <option data-bind="value:item.id,text:item.modelo"></option>
                            <!--/ko-->
                          </select>  
                        </div>
              ...
              <div class="col-md-9">
                ...
                <div class="row" data-bind="foreach:{data:listado_rutas, as:'item'}">
                     ...
                     <div class="col-md-4" >
                          <div class="card mt-4">
                            ...
                            <div class="card-body">
                               <p>Nombre de la ruta: <span data-bind="text:item.nombre_ruta"></span></p> 
                               <p>Origen: <span data-bind="text:item.origen"></span></p> 
                               <p>Destino: <span data-bind="text:item.destino"></span></p> 
                               <p>Modelo del Bus: <span data-bind="text:item.modelo_bus"></span></p> 
                               <p>Valor: <span data-bind="text:item.valor"></span></p> 
                            </div>
